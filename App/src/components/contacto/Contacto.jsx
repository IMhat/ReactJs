...
//             <form class="sectionwa-subtit-cont">
...
//                 <div className="inputsCont">
//                     <p className="tituloinput"></p>
//                     <input className="input" type="text" name="nombre" placeholder="Ingresá tu email" >
//                     </input>
//                     <textarea className="textarea" type="text" name="mensaje" placeholder="Escribí tu mensaje" ></textarea>

//                    <div className='buttoncont'>
//                         <a type="submit" className="wabotonmensaje" > Enviar mensaje </a>
//                     </div> : <div className='buttoncont'>
//                         <a type="submit" className="wabotonmensaje" > ¡Enviado!</a>
//                     </div>
